      ...
      <div class="row">
        <div class="col-lg-4 col-12 white-bg p-4 p-md-6">
          <a class="footer-logo" href="<?php echo base_url('/') ?>">
            <img id="footer-logo" class="img-fluid" src="images/logo-wil.png" alt="" style="width : 80%; height:50%;">
          </a>
        ...
        <div class="col-lg-8 col-12 p-4 p-md-6">
            ...
            <div class="col-md-4 col-sm-6 col-12 mt-6 mt-sm-0">
              ...
              <div class="footer-list">
                <ul class="list-unstyled">
                  ...
                  <li><a href="biochemistry-solution.html">Biochemistry Solution</a></li>
                  ...
                  <li><a href="diabetes-testing.html">Diabetes Testing</a></li>
                </ul>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col">
              <div class="copyright p-4 white-bg mt-5 ms-md-n6">Copyright © 2024 All rights reserved | Wil-Kh Powered by <i class="lar la-heart text-theme heartBeat2"></i>  <u><a href="https://www.spyderhub.com">Spyderhub</a></u></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div>
          <div class="row align-items-center">
            <div class="col-5 d-flex align-items-center">
              <div class="me-4">
                <button type="submit" class="btn btn-theme btn-sm"><i class="las la-times"></i></button>
              </div>
              <!-- Image -->
            ...
            <div class="col-7">
              ...
              <div class="product-meta"><span class="me-2 text-theme">$120.00</span><span class="text-muted">x 1</span></div>
            </div>
          </div>
        </div>
        <hr class="my-5">
        <div>
          <div class="row align-items-center">
            ...
            <div class="col-7">
              ...
              <div class="product-meta"><span class="me-2 text-theme">$160.00</span><span class="text-muted">x 1</span></div>
            </div>
          </div>
        </div>
        <hr class="my-5">
        <div class="d-flex justify-content-between align-items-center mb-8">
          ...
          <span class="text-dark">$280.00</span>
        </div>
        <a href="product-cart.html" class="btn btn-theme me-2">View Cart</a>
