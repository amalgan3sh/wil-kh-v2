  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        ...
        <h1 class="text-theme">Industrial Water Quality <span class="text-black">Testing Packages</span></h1>
        <nav aria-label="breadcrumb" class="page-breadcrumb border-top border-light pt-3 mt-3">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Industrial Water Quality Testing  Packages</li>
          </ol>
        </nav>
        </div>
      </div>
...
<section class="pt-0">
  <div class="container">
    <div class="row justify-content-center text-center">
      <div class="col-lg-7">
        <div class="section-title"><br><br><br>
          <h2 class="title">Industrial Water Quality Testing Packages 2024</h2><br><br>
    ...
    <tr>
        ...
        <th rowspan="2" style="border: 1px solid black;">Parameters</th>
        <th rowspan="2" style="border: 1px solid black;">Method</th>
        <th rowspan="2" style="border: 1px solid black;">Cost per sample</th>
    ...
    <tr>
        ...
        <td style="text-align: center; border: 1px solid black;">$2.00</td>
    ...
    <tr>
        ...
        <td style="text-align: center; border: 1px solid black;">$3.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="text-align: center; border: 1px solid black;">$9.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="border: 1px solid black;">Spectrophotometry</td>
        <td style="text-align: center; border: 1px solid black;">$10.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
    <tr>
        ...
        <td style="border: 1px solid black;">Spectrophotometry</td>
        <td style="text-align: center; border: 1px solid black;">$7.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="border: 1px solid black;">Residual chlorine (Cl<sub>2</sub>)</td>
        <td style="border: 1px solid black;">Spectrophotometry</td>
        <td style="text-align: center; border: 1px solid black;">$5.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
    <tr>
        ...
        <td style="border: 1px solid black;">Chlorine (Cl<sub>2</sub>), total</td>
        <td style="border: 1px solid black;">Spectrophotometry</td>
        <td style="text-align: center; border: 1px solid black;">$5.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
    ...
    <tr>
        ...
        <td style="border: 1px solid black;">Titration</td>
        <td style="text-align: center; border: 1px solid black;">$6.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="border: 1px solid black;">Carbonate (CO<sub>3</sub><sup>2-</sup>)</td>
        <td style="border: 1px solid black;">Titration</td>
        <td style="text-align: center; border: 1px solid black;">$7.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
    <tr>
        ...
        <td style="border: 1px solid black;">Bicarbonate (HCO<sub>3</sub><sup>-</sup>)</td>
        <td style="border: 1px solid black;">Titration</td>
        <td style="text-align: center; border: 1px solid black;">$7.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
...
<ul class="list-unstyled">
  <button class="mb-3"><span class="text-black font-w-5"><a href="<?php echo base_url('images/pdf/WIL_Industrial Water Test Information 2024.pdf'); ?>" download>Download</a></span></button>
</ul>
