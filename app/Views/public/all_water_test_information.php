  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        ...
        <h1 class="text-theme">All Water <span class="text-black">Testing Packages</span></h1>
        <nav aria-label="breadcrumb" class="page-breadcrumb border-top border-light pt-3 mt-3">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">All Water Testing Packages</li>
          </ol>
        </nav>
        </div>
      </div>
...
<section class="pt-0">
  <div class="container">
    <div class="row justify-content-center text-center">
      <div class="col-lg-8">
        <div class="section-title"><br><br><br>
            <h2>All Water Quality Testing Information Sheet 2024</h2>
    ...
    <tr style="background-color: #f2f2f2;">
        ...
        <th style="border: 1px solid black; width: 25%;">Parameter</th>
        <th style="border: 1px solid black; width: 25%;">Analysis Method</th>
        <th style="border: 1px solid black; width: 10%;">Cost per Sample</th>
    ...
    <tr>
        ...
        <td style="border: 1px solid black;">Kit</td>
    ...
    <tr>
        ...
        <td style="border: 1px solid black; text-align: right;">$15.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
    <tr>
        <td style="border: 1px solid black; text-align: center;">4</td>
        <td style="border: 1px solid black;">Barium (Ba)</td>
        <td style="border: 1px solid black;">Spectrophotometry</td>
        <td style="border: 1px solid black; text-align: right;">$10.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
    ...
    <tr>
        ...
        <td style="border: 1px solid black;">Cyanide (CN-)</td>
        <td style="border: 1px solid black;">Spectrophotometry</td>
        <td style="border: 1px solid black; text-align: right;">$15.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
    <tr>
        ...
        <td style="border: 1px solid black;">Spectrophotometry</td>
        <td style="border: 1px solid black; text-align: right;">$7.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="border: 1px solid black;">Nickel (Ni)</td>
        <td style="border: 1px solid black;">Spectrophotometry</td>
        <td style="border: 1px solid black; text-align: right;">$15.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
    <tr>
        ...
        <td style="border: 1px solid black;">Nitrate (NO₃-)</td>
        <td style="border: 1px solid black;">Spectrophotometry</td>
        <td style="border: 1px solid black; text-align: right;">$7.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
    <tr>
        ...
        <td style="border: 1px solid black;">Nitrite (NO₂-)</td>
        <td style="border: 1px solid black;">Spectrophotometry</td>
        <td style="border: 1px solid black; text-align: right;">$9.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
    <tr>
        <td style="border: 1px solid black; text-align: center;">13</td>
        <td style="border: 1px solid black;">Turbidity</td>
        <td style="border: 1px solid black;">Nephelometry</td>
        <td style="border: 1px solid black; text-align: right;">$3.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
    <tr>
        <td style="border: 1px solid black; text-align: center;">14</td>
        <td style="border: 1px solid black;">Residual chlorine (Cl₂)</td>
        <td style="border: 1px solid black;">Spectrophotometry</td>
        <td style="border: 1px solid black; text-align: right;">$5.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
    <tr>
        ...
        <td style="border: 1px solid black;">Electrometric</td>
        <td style="border: 1px solid black; text-align: right;">$3.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="border: 1px solid black;">Ammonia (NH₃)</td>
        <td style="border: 1px solid black;">Spectrophotometry</td>
        <td style="border: 1px solid black; text-align: right;">$5.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
    ...
    <tr>
        ...
        <td style="border: 1px solid black;">Sulfate (SO₄²-)</td>
        <td style="border: 1px solid black;">Spectrophotometry</td>
        <td style="border: 1px solid black; text-align: right;">$5.00</td>
        <td style="border: 1px solid black;"></td>
    </tr>
...
<tr>
    ...
    <td style="border: 1px solid black;">Total coliform</td>
    <td style="border: 1px solid black;">Membrane Filtration</td>
    <td style="border: 1px solid black; text-align: right;">$9.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    ...
    <td style="border: 1px solid black;">Magnesium (Mg)</td>
    <td style="border: 1px solid black;">Spectrophotometry</td>
    <td style="border: 1px solid black; text-align: right;">$7.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    ...
    <td style="border: 1px solid black;">Calcium (Ca)</td>
    <td style="border: 1px solid black;">Titration</td>
    <td style="border: 1px solid black; text-align: right;">$5.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    <td style="border: 1px solid black; text-align: center;">30</td>
    <td style="border: 1px solid black;">Chlorine (Cl₂), total</td>
    <td style="border: 1px solid black;">Spectrophotometry</td>
    <td style="border: 1px solid black; text-align: right;">$5.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    ...
    <td style="border: 1px solid black;">Sulfide (S²⁻)</td>
    <td style="border: 1px solid black;">Spectrophotometry</td>
    <td style="border: 1px solid black; text-align: right;">$5.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
...
<tr>
    ...
    <td style="border: 1px solid black;">Electrode</td>
    <td style="border: 1px solid black; text-align: right;">$2.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    <td style="border: 1px solid black; text-align: center;">35</td>
    <td style="border: 1px solid black;">ORP</td>
    <td style="border: 1px solid black;">Electrode</td>
    <td style="border: 1px solid black; text-align: right;">$5.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    ...
    <td style="border: 1px solid black;">Ammonium (NH₄⁺)</td>
    <td style="border: 1px solid black;">Spectrophotometry</td>
    <td style="border: 1px solid black; text-align: right;">$7.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    ...
    <td style="border: 1px solid black;">Oil and Grease</td>
    <td style="border: 1px solid black;">USEPA Method 1664</td>
    <td style="border: 1px solid black; text-align: right;">$13.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
...
<tr>
    ...
    <td style="border: 1px solid black;">Total Suspended Solid (TSS)</td>
    <td style="border: 1px solid black;">USEPA METHOD #: 160.2</td>
    <td style="border: 1px solid black; text-align: right;">$7.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    <td style="border: 1px solid black; text-align: center;">40</td>
    <td style="border: 1px solid black;">Chemical Oxygen Demand (COD)</td>
    <td style="border: 1px solid black;">Spectrophotometry</td>
    <td style="border: 1px solid black; text-align: right;">$15.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    ...
    <td style="border: 1px solid black;">Phosphate (PO₄³⁻)</td>
    <td style="border: 1px solid black;">Spectrophotometry</td>
    <td style="border: 1px solid black; text-align: right;">$7.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    ...
    <td style="border: 1px solid black;">Silica (SiO₂)</td>
    <td style="border: 1px solid black;">Spectrophotometry</td>
    <td style="border: 1px solid black; text-align: right;">$9.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    ...
    <td style="border: 1px solid black;">Non-carbonate hardness</td>
    <td style="border: 1px solid black;"></td>
    <td style="border: 1px solid black; text-align: right;">$7.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    ...
    <td style="border: 1px solid black;">Total Solid (TS)</td>
    <td style="border: 1px solid black;"></td>
    <td style="border: 1px solid black; text-align: right;">$5.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    ...
    <td style="border: 1px solid black;">Potassium (K)</td>
    <td style="border: 1px solid black;">Spectrophotometry</td>
    <td style="border: 1px solid black; text-align: right;">$9.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    ...
    <td style="border: 1px solid black;">Biochemical Oxygen Demand (BOD)</td>
    <td style="border: 1px solid black;">USEPA METHOD #: 405.1</td>
    <td style="border: 1px solid black; text-align: right;">$20.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    <td style="border: 1px solid black; text-align: center;">47</td>
    <td style="border: 1px solid black;">Total Nitrogen (TN)</td>
    <td style="border: 1px solid black;">Spectrophotometry</td>
    <td style="border: 1px solid black; text-align: right;">$15.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    ...
    <td style="border: 1px solid black;">Total Phosphorus (TP)</td>
    <td style="border: 1px solid black;">Spectrophotometry</td>
    <td style="border: 1px solid black; text-align: right;">$12.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
...
<tr>
    ...
    <td style="border: 1px solid black;">Alkalinity, Total</td>
    <td style="border: 1px solid black;">Titration</td>
    <td style="border: 1px solid black; text-align: right;">$6.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    <td style="border: 1px solid black; text-align: center;">51</td>
    <td style="border: 1px solid black;">Phenolphthalein Alkalinity</td>
    <td style="border: 1px solid black;">Titration</td>
    <td style="border: 1px solid black; text-align: right;">$5.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    ...
    <td style="border: 1px solid black;">Carbonate (CO₃²⁻)</td>
    <td style="border: 1px solid black;">Titration</td>
    <td style="border: 1px solid black; text-align: right;">$7.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    <td style="border: 1px solid black; text-align: center;">53</td>
    <td style="border: 1px solid black;">Bicarbonate (HCO₃⁻)</td>
    <td style="border: 1px solid black;">Titration</td>
    <td style="border: 1px solid black; text-align: right;">$7.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
...
<tr>
    <td style="border: 1px solid black; text-align: center;">55</td>
...
<tr>
    ...
    <td style="border: 1px solid black;">Total Organic Carbon (TOC)</td>
    <td style="border: 1px solid black;">Spectrophotometry</td>
    <td style="border: 1px solid black; text-align: right;">$30.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    <td style="border: 1px solid black; text-align: center;">57</td>
    <td style="border: 1px solid black;">Cobalt (Co)</td>
    <td style="border: 1px solid black;">Spectrophotometry</td>
    <td style="border: 1px solid black; text-align: right;">$15.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    ...
    <td style="border: 1px solid black;">Boron (B)</td>
    <td style="border: 1px solid black;">Spectrophotometry</td>
    <td style="border: 1px solid black; text-align: right;">$10.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    <td style="border: 1px solid black; text-align: center;">59</td>
    <td style="border: 1px solid black;">Molybdenum (Mo)</td>
    <td style="border: 1px solid black;">Spectrophotometry</td>
    <td style="border: 1px solid black; text-align: right;">$15.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    ...
    <td style="border: 1px solid black;">Aldrin</td>
    <td style="border: 1px solid black;">GC-MS</td>
    <td style="border: 1px solid black; text-align: right;">$20.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    <td style="border: 1px solid black; text-align: center;">61</td>
    <td style="border: 1px solid black;">p'p, DDD</td>
    <td style="border: 1px solid black;">GC-MS</td>
    <td style="border: 1px solid black; text-align: right;">$18.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    <td style="border: 1px solid black; text-align: center;">62</td>
    <td style="border: 1px solid black;">p'p, DDE</td>
    <td style="border: 1px solid black;">GC-MS</td>
    <td style="border: 1px solid black; text-align: right;">$18.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    ...
    <td style="border: 1px solid black;">DDT</td>
    <td style="border: 1px solid black;">GC-MS</td>
    <td style="border: 1px solid black; text-align: right;">$18.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    ...
    <td style="border: 1px solid black;">Endrin</td>
    <td style="border: 1px solid black;">GC-MS</td>
    <td style="border: 1px solid black; text-align: right;">$20.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    ...
    <td style="border: 1px solid black;">Hexachlorobenzen</td>
    <td style="border: 1px solid black;">GC-MS</td>
    <td style="border: 1px solid black; text-align: right;">$25.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
<tr>
    <td style="border: 1px solid black; text-align: center;">66</td>
    <td style="border: 1px solid black;">Heptachlor</td>
    <td style="border: 1px solid black;">GC-MS</td>
    <td style="border: 1px solid black; text-align: right;">$25.00</td>
    <td style="border: 1px solid black;"></td>
</tr>
...
<ul class="list-unstyled">
  <button class="mb-3"><span class="text-black font-w-5"><a href="<?php echo base_url('images/pdf/WIL_Water Quality Testing Information Sheet 2024.pdf'); ?>" download>Download</a></span></button>
</ul>
