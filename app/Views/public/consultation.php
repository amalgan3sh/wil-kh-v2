...
<section class="page-title parallaxie" data-bg-img="images/client/img_2.jpg" alt="">
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        <div class="white-bg p-md-5 p-3 d-inline-block">
        <h1 class="text-theme">Consultation<span class="text-black"></span></h1>
        <nav aria-label="breadcrumb" class="page-breadcrumb border-top border-light pt-3 mt-3">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Consultatiot</li>
          </ol>
        </nav>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-lg-8 col-md-12 pe-lg-5">
        <div class="service-details">
          <img class="img-fluid w-100 mb-4" src="images/client/img_23.jpg" alt="">
          <h3 class="mb-3">Innovative Consultation for Sustainable Development</h3>
          <p class="lead">Our experts provide consultation services in water, food, and environmental sciences to 
            businesses, NGOs, and government agencies, helping ensure compliance with environmental 
            standards and promoting sustainable development. </p>
          ...
          <p class="my-5">Leverage our expertise in water, food, and environmental sciences. We provide consultation services 
            for businesses, NGOs, and government agencies to ensure compliance with environmental standards and sustainable development goals. </p>
            ...
            <div class="col-md-6 mt-5 mt-md-0">
              <div class="featured-item py-0 text-center shadow-none style-2">
                ...
                <div class="featured-desc">
                  ...
                  <p>We ensure all food products are nutritionally balanced and compliant with regulatory standards.</p>
                </div>
              </div>
            </div>
            <div class="col-md-6 mt-5 mt-md-0">
        ...
        <div class="widget p-4 mb-5 light-bg">
          <div class="sidebar-links">
            <ul class="list-unstyled">
              ...
              <li class="active"><a href="consultation">Consultation</a>
              </li>
