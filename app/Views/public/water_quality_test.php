          ...
          <div class="col-lg-4">
            <div class="featured-item shadow-none d-flex align-items-start style-2 border-end border-light border-bottom">
              ...
              <div class="featured-desc">
                ...
                <p>We employ proper sampling techniques to ensure representative and uncontaminated water samples.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="featured-item shadow-none d-flex align-items-start style-2 border-end border-light border-bottom">
              ...
              <div class="featured-desc">
                ...
                <p>Our laboratory utilizes cutting-edge equipment to analyze samples for various contaminants and parameters.</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
    ...
    <div class="row justify-content-center text-center">
      <div class="col-lg-8">
        <div class="section-title">
          <h2 class="title">Our Water Quality Testing Services</h2> 
        </div>
      </div>
    </div>
  </div>
