      ...
      <div class="row align-items-center mb-6">
        ...
        <div class="col-lg-7 col-12 mt-5 mt-lg-0 ps-lg-5">
          <div>
            ...
            <p class="lead mb-4">The WIL Laboratory is dedicated to addressing core needs in Cambodia:</p>
            <ul class="list-unstyled">
              <li class="mb-3"><span class="text-black font-w-5">Make water, soil and food quality testing services available to organizations, companies, and individuals to ensure drinking water and foods are safe and the environment is protected</span></li>
              <li class="mb-3"><span class="text-black font-w-5">Research emerging environmental and public health issues such as water pollution and food safety</span></li>
              <li class="mb-3"><span class="text-black font-w-5">Support for training the next generation of Cambodian scientists about science and technology for sustainability</span></li>
            </ul>
            <div class="light-bg p-3">
              <ul class="list-unstyled">
                ...
                <li><span class="text-black font-w-5">Client:</span> <a href="www.wil-kh.com">WIL-KH</a></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="owl-carousel no-pb popup-gallery" data-dots="false" data-items="5" data-md-items="3" data-sm-items="2" data-xs-items="1" data-margin="10">
            <div class="item">
              <div class="cases-item position-relative overflow-hidden">
                ...
                <a class="popup-img" href="https://images.pexels.com/photos/3912365/pexels-photo-3912365.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"> <i class="las la-plus"></i> </a>
            ...
            <!-- Additional recent research project items -->
          </div>
        </div>
      </div>
    </div>
